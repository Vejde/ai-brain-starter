...
3. **Verify**: Check the result. Does it match intent? Sources correct? Voice right?
...
- "think carefully" -- feature implementation, content strategy
- "think hard" -- architecture decisions, complex analysis
- "ultrathink" -- critical deliverables, regulatory-sensitive work
