...
3. **Verify**: Check the result. Does it match intent?
...
- "think hard" -- feature implementation, complex analysis
- "think harder" -- architecture decisions
- "ultrathink" -- critical deliverables, security-sensitive work
